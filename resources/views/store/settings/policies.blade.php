...
<section class="col-lg-8">
    <div class="box box-default">
        <div class="box-header"><div class="box-title">Policy Management</div></div>
        <div class="box-body">
            <form class="form-horizontal" role="form" method="POST" action="/store/settings/add_policy" id="storePolicy">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="policy_content" class="form-control format_able" name="policy_content" autofocus></textarea>
